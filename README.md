...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-vimix](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-vimix`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-vimix
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-vimix/iso-profile/dist`
...
| [ubuntu-iso-builder-remix-budgie-theme-vimix](https://github.com/samwhelp/ubuntu-iso-builder-remix-budgie-theme-vimix) | [ubuntu-iso-builder-respin-budgie](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie) |
